...
function p4_initialize(inspiration) {
  ...
  if (inspiration.name.indexOf("mountain") != -1){
    return {type: "strawberry", r_range:{max: 100, min: 30}, opa_range:{min: 128, max: 255}, intervals: 5, 
            sample_x: [0, 1], sample_y:[0, 1], c_rangemin_c: 0, max_c: 10};    
  }
}
...
const MAX_R = {apple: 200, cherry: 100, strawberry: 50, mountain: 58.8};
const MIN_R = {apple: 20, cherry: 10, strawberry: 5, mountain: 10};

const MAX_C = {apple: 15, cherry: 5, strawberry: 10, mountain: 20};
const MIN_C = {apple: 0, cherry: 1, strawberry: 1, mountain: 3};
